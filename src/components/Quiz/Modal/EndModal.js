...
export default function PreQuizModal({ show, info, stats, content, gameStart, modeSelected="default" }) {
  ...
  return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <SimpleButton name="Try Again" onClick={() => history.push(history.location.pathname)} />
        </Modal.Body>
      </Modal>
  );
}
